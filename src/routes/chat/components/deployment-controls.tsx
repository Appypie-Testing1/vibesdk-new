		...
		switch (state) {
			...
			case DeploymentState.READY_TO_DEPLOY:
				return {
					...
					subtitle: "It's Free! Deploys to Snappy Workers for Platform",
					...
					<div className="flex items-center gap-3 mb-3">
						...
						<div className="flex-1">
							...
							<div className="text-xs text-green-700 dark:text-green-300 mt-0.5">
								Your application is now live on Snappy Workers
							</div>
						</div>
					</div>
